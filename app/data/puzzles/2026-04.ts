...
export const PUZZLES_2026_04: DailyPuzzle[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        clue: 'Top scorer at the 2002 World Cup with eight goals',
        answer: 'RONALDO',
        category: 'player',
        difficulty: 2,
        isProperNoun: true,
  ...
  },
  {
    ...
    questions: [
      ...
      {
        clue: 'Arrived at Manchester United from Lazio for a then-world record fee in 2001 — best remembered for his time at Inter and Lazio before the move',
        answer: 'VERON',
        category: 'player',
        difficulty: 4,
        isProperNoun: true,
