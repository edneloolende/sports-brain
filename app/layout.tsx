...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${inter.variable} ${bitter.variable} bg-[#14161c]`}>
      <head>
      ...
      <body className="min-h-[100svh] antialiased font-[var(--font-inter)] flex flex-col bg-[#14161c]">
        <div className="flex-1 pb-10">{children}</div>
        <footer className="fixed bottom-0 left-0 right-0 flex items-center justify-center gap-4 py-3 text-xs text-white/25 bg-[#14161c]">
